...
class Date extends Component{
    ...
    ajouter =(event)=>{
        ...
        axios.post(`http://localhost:8090/ajouterdate/${data.date1}/${data.date2}`,data).then(res=>
        {
    ...
    lire=()=>{
        ...
        axios.post("http://localhost:8090/ajouterdate").then(res => {
      ...
      date=()=>{
        ...
        axios.post(`http://localhost:8090/ajouterdate/${data.date1}/${data.date2}`).then(res => {
            const element = res.data;
            this.setState({element });
            console.log(element)
          }).catch(error=>console.error(error))
    ...
    <div class="modal" id="myModal">
      <div class="modal-dialog">
        <div class="modal-content">
         ...
         <input type="date" class="form-control" name="date1" onChange={this.ChangeDate1} />
          Entrer  la date: 
          <input type="date" class="form-control" name="date2" onChange={this.ChangeDate2} /> <br/>
          ...
          <div className="card mb-3">
            ...
            return(<tr>
                ...
                <td><a class="btn btn-warning" href="#" >modif</a></td>
              </tr>)
        })}
